...
import com.example.listener.baselistListener;
...
public class setbaselist {
	...
	public setbaselist(String username, Context context, ListView baselist) {
	...
	public void clicker() {
		baselist.setOnItemClickListener(new baselistListener(username, context,
				baselist));
